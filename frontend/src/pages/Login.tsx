      ...
      >
        <div className="glass-card rounded-2xl p-8">
          <div className="mb-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-text-primary">Mentor AI Studio</h1>
            <p className="mt-1 text-sm text-text-tertiary">Sign in to continue your learning journey</p>
          </div>
