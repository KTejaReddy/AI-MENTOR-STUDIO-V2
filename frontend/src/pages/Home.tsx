...
export function Home() {
  ...
  return (
    <div className="bg-[#000000] text-white w-full overflow-x-hidden relative font-sans selection:bg-indigo-500/30">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 pb-32 pt-16 flex flex-col gap-32 min-h-screen">

        {/* The 5 completely distinct, non-rectangular UI paradigms */}
        <AITutorModule />
        <CompilerModule />
        <DocumentTutorModule />
        <NotesModule />
        ...
        <footer className="mt-24 pt-10 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 text-[#94A3B8] text-sm">
