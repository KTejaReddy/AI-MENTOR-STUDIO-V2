...
export function Home() {
  ...
  return (
    <div className="bg-[#000000] text-white w-full overflow-x-hidden relative font-sans selection:bg-indigo-500/30">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-4 md:px-8 pb-16 pt-6 flex flex-col gap-6 md:gap-8 min-h-screen">

        {/* The 5 completely distinct, non-rectangular UI paradigms inside a 12-column grid */}
        <div className="grid grid-cols-12 gap-4 md:gap-6 lg:gap-8 w-full">
           <AITutorModule />
           
           <Suspense fallback={<div className="col-span-12 md:col-span-6 lg:col-span-7 h-[400px] bg-slate-900/10 animate-pulse rounded-lg border border-slate-800/20" />}>
              <CompilerModule />
           </Suspense>
           
           <Suspense fallback={<div className="col-span-12 md:col-span-6 lg:col-span-5 h-[400px] bg-slate-900/10 animate-pulse rounded-lg border border-slate-800/20" />}>
              <DocumentTutorModule />
           </Suspense>
