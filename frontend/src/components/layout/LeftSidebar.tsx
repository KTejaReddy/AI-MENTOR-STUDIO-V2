  ...
  return (
    <aside className="w-80 h-full flex flex-col overflow-hidden shrink-0 panel" style={{ pointerEvents: 'auto' }}>
      <div className="px-4 py-3 border-b border-border shrink-0">
        <h2 className="text-xs font-semibold text-text-primary">Lesson Sections</h2>
        {isGenerating ? (
          <p className="text-[10px] text-[#00C2FF] flex items-center gap-1.5 mt-0.5 font-medium animate-pulse">
          ...
          <p className="text-[10px] text-text-tertiary mt-0.5">{statusCount} sections</p>
        )}
      </div>
          ...
          const isActive = activeSectionId === sectionId
            ...
            return (
              <motion.button
                ...
                className={cn(
                  'w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl text-xs transition-all text-left group relative overflow-hidden',
                  isActive
              ...
              >
                ...
                <span className="relative z-10 text-[9px] font-mono text-text-tertiary w-3 shrink-0">{idx + 1}.</span>
                ...
                <span className="relative z-10"><StatusIcon status={sStatus} /></span>
              </motion.button>
            )
          })}
        </nav>
        ...
        <AnimatePresence>
          {doneCount > 0 && (
            ...
            >
              ...
              <div className="h-1.5 rounded-full bg-surface-200/50 overflow-hidden relative border border-white/5">
                <motion.div
